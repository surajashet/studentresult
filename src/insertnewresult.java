...
public class insertnewresult extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String htmlcss=jTextField6.getText();
        try{
      ...
      if(rs.next())
      {
          st.executeUpdate( "INSERT INTO insertmarks (roll, dsa, dbms, java, c, htmlcss) VALUES ('" + rollno + "', '" + dsa + "', '" + dbms + "', '" + java + "', '" + c + "', '" + htmlcss + "')");      
       ...
       new insertnewresult().setVisible(true);
        ...
        {
              JOptionPane.showMessageDialog(null,"roll numbers does not exist in database ");
