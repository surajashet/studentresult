 ...
 * @author suraj
 */
public class allstudentresut extends javax.swing.JFrame {

    /**
     * Creates new form allstudentresut
     */
    public allstudentresut() {
        initComponents();
    }
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
      try{
            ...
            ResultSet rs=st.executeQuery("select*from insertmarks");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(allstudentresut.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
